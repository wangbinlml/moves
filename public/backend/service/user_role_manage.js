...
$("#user-search").on("click", function () {
    datatable.ajax.url('/admin/user_role/load?s_user_name=' + $("#s_user_name").val() + '&s_name=' + $("#s_name").val()).load();
});